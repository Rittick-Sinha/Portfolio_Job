...
`,
  ...
  "C++","Python", "HTML", "CSS", "JavaScript", "TypeScript", "ReactJS", "NextJS", "Tailwind CSS",
  "shadcn/ui", "NodeJS", "ExpressJS", "MongoDB", "Git", "GitHub", "Vercel", 
  "Postman", "Linux", "Windows", "npm", "Radix UI"
];
...
`,
  ...
  contact: `const contactDetails = {
    name: "Rittick Sinha",
    email: "sinharittick5@gmail.com",
    mobile: "+91-7439356601",
    location: "Kolkata, India",
    linkedIn: "linkedin.com/in/cypherab01",
    github: "github.com/cypherab01",
    leetcode: "github.com/cypherab01",
  };
